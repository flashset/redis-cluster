...
set slaveLen=3
set slave[0].Ip=127.0.0.1
set slave[0].Port=7379
set slave[0].MasterIp=127.0.0.1
set slave[0].MasterPort=6379

set slave[1].Ip=127.0.0.1
set slave[1].Port=7380
set slave[1].MasterIp=127.0.0.1
set slave[1].MasterPort=6380

set slave[2].Ip=127.0.0.1
set slave[2].Port=7381
set slave[2].MasterIp=127.0.0.1
